# -*- coding: utf-8 -*-
"""
Created on Tue Jun  7 19:56:31 2022
...
my_pic = ImageTk.PhotoImage(file="reg.png")
my_pic2 = ImageTk.PhotoImage(file="reg.png")
my_pic3 = ImageTk.PhotoImage(file="reg.png")
